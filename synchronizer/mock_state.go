...
// StateMock_GetL2BlockByNumber_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetL2BlockByNumber'
type StateMock_GetL2BlockByNumber_Call struct {
	*mock.Call
}
...
//   - blockNumber uint64
//   - dbTx pgx.Tx
func (_e *StateMock_Expecter) GetL2BlockByNumber(ctx interface{}, blockNumber interface{}, dbTx interface{}) *StateMock_GetL2BlockByNumber_Call {
...
func (_c *StateMock_GetL2BlockByNumber_Call) Return(_a0 *state.L2Block, _a1 error) *StateMock_GetL2BlockByNumber_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StateMock_GetL2BlockByNumber_Call) RunAndReturn(run func(context.Context, uint64, pgx.Tx) (*state.L2Block, error)) *StateMock_GetL2BlockByNumber_Call {
	_c.Call.Return(run)
	return _c
}
...
// StateMock_GetLastL2BlockNumber_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetLastL2BlockNumber'
type StateMock_GetLastL2BlockNumber_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - dbTx pgx.Tx
func (_e *StateMock_Expecter) GetLastL2BlockNumber(ctx interface{}, dbTx interface{}) *StateMock_GetLastL2BlockNumber_Call {
	return &StateMock_GetLastL2BlockNumber_Call{Call: _e.mock.On("GetLastL2BlockNumber", ctx, dbTx)}
}

func (_c *StateMock_GetLastL2BlockNumber_Call) Run(run func(ctx context.Context, dbTx pgx.Tx)) *StateMock_GetLastL2BlockNumber_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(pgx.Tx))
	})
	return _c
...
func (_c *StateMock_GetLastL2BlockNumber_Call) Return(_a0 uint64, _a1 error) *StateMock_GetLastL2BlockNumber_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StateMock_GetLastL2BlockNumber_Call) RunAndReturn(run func(context.Context, pgx.Tx) (uint64, error)) *StateMock_GetLastL2BlockNumber_Call {
	_c.Call.Return(run)
	return _c
}
...
// StateMock_UpdateForkIDBlockNumber_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateForkIDBlockNumber'
type StateMock_UpdateForkIDBlockNumber_Call struct {
	*mock.Call
}
...
//   - updateMemCache bool
//   - dbTx pgx.Tx
func (_e *StateMock_Expecter) UpdateForkIDBlockNumber(ctx interface{}, forkdID interface{}, newBlockNumber interface{}, updateMemCache interface{}, dbTx interface{}) *StateMock_UpdateForkIDBlockNumber_Call {
	return &StateMock_UpdateForkIDBlockNumber_Call{Call: _e.mock.On("UpdateForkIDBlockNumber", ctx, forkdID, newBlockNumber, updateMemCache, dbTx)}
}

func (_c *StateMock_UpdateForkIDBlockNumber_Call) Run(run func(ctx context.Context, forkdID uint64, newBlockNumber uint64, updateMemCache bool, dbTx pgx.Tx)) *StateMock_UpdateForkIDBlockNumber_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StateMock_UpdateForkIDBlockNumber_Call) Return(_a0 error) *StateMock_UpdateForkIDBlockNumber_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *StateMock_UpdateForkIDBlockNumber_Call) RunAndReturn(run func(context.Context, uint64, uint64, bool, pgx.Tx) error) *StateMock_UpdateForkIDBlockNumber_Call {
	_c.Call.Return(run)
	return _c
}
